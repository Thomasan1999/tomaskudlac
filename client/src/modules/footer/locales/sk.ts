...
export default {
    ...
    'cookiesInfo': {
        ...
        'text': [
            {
                'title': 'Súbory cookie',
                'text': 'StoreState cieľom získať štatistiky ohľadom používania tejto webovej stránky ukladáme na vašom zariadení malé dátové súbory, tzv. cookie. Je to bežná prax väčšiny veľkých webových stránok.'
            },
            {
