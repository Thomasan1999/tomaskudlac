/** @description A class providing methods to return a psuedorandomized number. Randomization is executed by the Math.random method. */
export default class Rand
{
     ...
     * @param [args.max] The maximal possible value of the randomized number, defaults to the largest number that can be represented in JS (Number.MAX_VALUE).
     ...
     * @param [args.max] The maximal value of the randomized number (can be float), defaults to the largest integer that can be represented in JS (Number.MAX_SAFE_INTEGER).
